...
****Questions: Having some trouble getting my table 1 to print out correctly, do you have any tips?
...
```{r}
#Importing Data + Creating Means for OSCE Scores
...
```
1. T-Tests: USMLE Step Scores
Hypothesis - Exploratory: Do Step Scores differ across URM Status?
...
2. Chi-Squared Analysis: Clerkship Scores
Hypothesis - Exploratory: Do clerkship scores differ across URM Status?
```{r}

```

3. T-Tests: Mean OSCE scores for each domain (physical exam, communication exam, documentation exam, and oral presentation)
...
Interpretation for OSCE Scores

Interpretation for USMLE Scores

Interpretation for Clerkship Scores
